function affiche() {
    ...
    if (select.options[select.selectedIndex].value === "FR"){
        if (etatmanu){
            ...
            $("#Jin").attr("href","/Personnage/Jin.html?lang=FR&List=on");
        }else {
            ...
            $("#Jin").attr("href","/Personnage/Jin.html?lang=FR&List=off");
        }
        ...
        if (etatmanu){
            ...
            $("#Jin").attr("href","/Personnage/Jin.html?lang=EN&List=on");
        }else {
            ...
            $("#Jin").attr("href","/Personnage/Jin.html?lang=EN&List=off");
        }
